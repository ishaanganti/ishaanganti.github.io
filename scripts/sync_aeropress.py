...
<head>
    ...
    <style>
        ...
        * {{ box-sizing:border-box; }}
        body {{ font-family:"Inter",system-ui,-apple-system,sans-serif; background:var(--bg); color:var(--text); max-width:720px; margin:72px auto; padding:0 24px; line-height:1.65; font-size:17px; }}
